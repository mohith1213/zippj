...
export default function UnifiedLoanApplication({ onSubmit, initialData }) {
  ...
  // File inputs: store filename as indicator (no real upload in this version)
    ...
    <div className="section-card">
      ...
      <div className="grid-2">
        ...
        <div className="form-field">
          ...
          <input name="photograph" type="file" className="form-control" onChange={handleFileInputChange} />
        </div>
        <div className="form-field">
          <label className="form-label">ID Proof</label>
          <input name="idProof" type="file" className="form-control" onChange={handleFileInputChange} />
        </div>
        <div className="form-field">
          <label className="form-label">Address Proof</label>
          <input name="addressProof" type="file" className="form-control" onChange={handleFileInputChange} />
        </div>
        <div className="form-field">
          <label className="form-label">CIBIL Report</label>
          <input name="cibilReport" type="file" className="form-control" onChange={handleFileInputChange} />
        </div>
        ...
        {formData.occupationType === "Salaried" && (
          <>
            <div className="form-field">
              ...
              <input name="salariedPayslip" type="file" className="form-control" onChange={handleFileInputChange} />
            </div>
            <div className="form-field">
              <label className="form-label">Employment Proof</label>
              <input name="salariedEmploymentProof" type="file" className="form-control" onChange={handleFileInputChange} />
            </div>
            <div className="form-field">
              <label className="form-label">ITR (Salaried)</label>
              <input name="salariedItr" type="file" className="form-control" onChange={handleFileInputChange} />
            </div>
          </>
        )}
        ...
        {formData.occupationType === "Self-Employed" && (
          <>
            <div className="form-field">
              ...
              <input name="selfItr" type="file" className="form-control" onChange={handleFileInputChange} />
            </div>
            <div className="form-field">
              <label className="form-label">GST Registration</label>
              <input name="selfGst" type="file" className="form-control" onChange={handleFileInputChange} />
            </div>
            <div className="form-field">
              <label className="form-label">Bank Statements (3-6 months)</label>
              <input name="selfBankStatements" type="file" className="form-control" onChange={handleFileInputChange} />
            </div>
          </>
        )}
        ...
        {formData.loanType === "Home Loan" && (
          <>
            <div className="form-field">
              ...
              <input name="homeEc" type="file" className="form-control" onChange={handleFileInputChange} />
            </div>
            <div className="form-field">
              <label className="form-label">Sale Agreements</label>
              <input name="homeSaleAgreements" type="file" className="form-control" onChange={handleFileInputChange} />
            </div>
          </>
        )}
        ...
        {formData.loanType === "Vehicle Loan" && (
          <>
            <div className="form-field">
              ...
              <input name="vehicleInvoice" type="file" className="form-control" onChange={handleFileInputChange} />
            </div>
            <div className="form-field">
              <label className="form-label">Vehicle Quotation</label>
              <input name="vehicleQuotation" type="file" className="form-control" onChange={handleFileInputChange} />
            </div>
          </>
        )}
      </div>
